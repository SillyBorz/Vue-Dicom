/*! cornerstone-tools - 2.5.0 - 2019-02-19 | (c) 2017 Chris Hafey | https://github.com/cornerstonejs/cornerstoneTools */
...
/******/ 	var hotCurrentHash = "e2b12f5c2b6d7c11b1ba"; // eslint-disable-line no-unused-vars
...
function onImageRendered(e) {
  ...
  var _loop = function _loop(i) {
    ...
    (0, _drawing.draw)(context, function (context) {
      ...
      (0, _drawing.drawLines)(context, eventData.element, lines, { color: color });
      ...
      var text = rAngle.toString() + data.unit;
...
function deleteNearbyMeasurement(mouseEventData) {
  ...
  var _getToolOptions = (0, _toolOptions.getToolOptions)(toolType, element),
      mouseButtonMask = _getToolOptions.mouseButtonMask;

  var buttonClicked = mouseEventData.detail.which;

  var foundDataToDelete = false;
  var imageNeedsUpdate = false;

  if (!(0, _isMouseButtonEnabled2.default)(buttonClicked, mouseButtonMask)) {
    return;
  }
...
function endDrawing(eventData, handleNearby) {
  ...
  if (deleteData) {
    ...
    (0, _triggerMeasurementCompletedEvent2.default)(eventData.element, data, toolType);
  }
...
function onImageRendered(e) {
  ...
  var _getColRowPixelSpacin2 = (0, _getColRowPixelSpacing2.default)(eventData.image),
      rowPixelSpacing = _getColRowPixelSpacin2.rowPixelSpacing,
      colPixelSpacing = _getColRowPixelSpacin2.colPixelSpacing;
  ...
  var _loop = function _loop(i) {
    ...
    (0, _drawing.draw)(context, function (context) {
      ...
      (0, _drawing.drawLine)(context, element, data.handles.start, data.handles.end, { color: color });
...
function drawZoomedElement(eventData) {
  ...
  _externalModules2.default.cornerstone.enable(zoomElement, enabledElement.options);
...
function onImageRendered(e) {
  ...
  var fontHeight = _textStyle2.default.getFontSize();
  var config = probe.getConfiguration();
  ...
  var _loop = function _loop(i) {
    ...
    (0, _drawing.draw)(context, function (context) {
      ...
      if (data.str && data.text) {
        ...
        (0, _drawTextBox2.default)(context, data.str, textCoords.x, textCoords.y + fontHeight + 5, color);
        (0, _drawTextBox2.default)(context, data.text, textCoords.x, textCoords.y, color);
      }
    });
  };
...
function calculateDisplayData(data, element, image) {
  ...
  if (x >= 0 && y >= 0 && x < image.columns && y < image.rows) {
    if (image.color) {
      data.text = x + ', ' + y;
      storedPixels = (0, _getRGBPixels2.default)(element, x, y, 1, 1);
      data.str = 'R: ' + storedPixels[0] + ' G: ' + storedPixels[1] + ' B: ' + storedPixels[2];
    } else {
      storedPixels = _externalModules2.default.cornerstone.getStoredPixels(element, x, y, 1, 1);
      var sp = storedPixels[0];
...
function onImageRendered(e) {
  ...
  var _loop = function _loop(i) {
    ...
    (0, _drawing.draw)(context, function (context) {
      ...
      if (data.rAngle) {
        var text = textBoxText(data, eventData.image);
...
var FusionRenderer = function () {
  ...
  _createClass(FusionRenderer, [{
    ...
    value: function render(element, imageStacks) {
      ...
      return cornerstone.loadAndCacheImage(currentImageId).then(function (baseImage) {
        ...
        overlayImageStacks.forEach(function (imgObj, overlayLayerIndex) {
          ...
          if (imageId) {
            ...
            var promise = cornerstone.loadAndCacheImage(imageId).then(function (image) {
...
var _getDefault = __webpack_require__(/*! ./getDefault.js */ "./util/getDefault.js");
...
function path(context, options, fn) {
  ...
  context.lineWidth = lineWidth || lineWidth === undefined && _toolStyle2.default.getToolWidth() || context.lineWidth;
  if (lineDash) {
...
function setShadow(context, options) {
  if (options.shadow) {
    context.shadowColor = (0, _getDefault.getDefault)(options.shadowColor, '#000000');
    context.shadowBlur = (0, _getDefault.getDefault)(options.shadowBlur, 0);
    context.shadowOffsetX = (0, _getDefault.getDefault)(options.shadowOffsetX, 1);
    context.shadowOffsetY = (0, _getDefault.getDefault)(options.shadowOffsetY, 1);
  }
}
...
function fillTextLines(context, boundingBox, textLines, fillStyle, padding) {
  ...
  context.font = _textStyle2.default.getFont();
...
exports.default = function (image) {
  ...
  return { rowPixelSpacing: rowPixelSpacing,
...
/***/ "./util/triggerMeasurementCompletedEvent.js":
/*!**************************************************!*\
  !*** ./util/triggerMeasurementCompletedEvent.js ***!
  \**************************************************/
/*! no static exports found */
...
exports.default = function (element, data, toolType) {
...
var _triggerEvent = __webpack_require__(/*! ./triggerEvent.js */ "./util/triggerEvent.js");
